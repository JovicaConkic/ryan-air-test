    ...
    grunt.initConfig({
            ...
            livereload: {
                options: {
                    ...
                    middleware: function (connect, options) {
                        var rules = [
                            '!\\.html|\\.js|\\.css|\\.svg|\\.jp(e?)g|\\.png|\\.gif|\\.otf|\\.ttf|\\.eot|\\.woff|\\.woff2$ /index.html [L]'
                        ];
                        return [
                            rewrite(rules),
                            lrSnippet,
        ...
        copy: {
            main: {
                expand: true,
                cwd: '<%= project.app %>/',
                src: ['**/*', '.htaccess', '!**/assets/css/**', '!**/assets/js/**', '!**/assets/app/**/*.js'],
                dest: '<%= project.dist %>'
            }
        },
        /**
        ...
        ngconstant: {
            dev: {
                ...
                constants: function () {
                    ...
                    pkg.apiPath = 'https://murmuring-ocean-10826.herokuapp.com/en/api/2';
                    return {
                        envPackage: pkg
                    };
                },
